    ...
    */
    ...
    queryRenderedFeatures(queryGeometry: any, params: any, zoom: number, bearing: number) {
        ...
        for (const id in this.sourceCaches) {
            ...
            const results = queryRenderedFeatures(this.sourceCaches[id], this._layers, queryGeometry, params, zoom, bearing, this.placement ? this.placement.collisionIndex : null);
